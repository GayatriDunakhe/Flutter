...
import 'Services/API/ImageApi.dart';
...
class _MyHomePageState extends State<MyHomePage> {
        ...
        child: Center(
          child: Column(
            children: [
              ...
              ? Column(
                children: [
                  Text("Unable to load images", style: cstmTextStyle(fc: Colors.black),),
  ...
  Future<void> getImgList() async {
    ...
    List<ImageModel> tempImgModel = await fetchImageApi();

    if(tempImgModel.isEmpty){
